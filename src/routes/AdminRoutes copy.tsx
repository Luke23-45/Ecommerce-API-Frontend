...
// import DiscountList from "@/components/admin/checkoutsession/Discounts/DiscountList";
// import DiscountForm from "@/components/admin/checkoutsession/Discounts/DiscountForm/DiscountForm";
...
const AdminRoutes: RouteObject[] = [
  ...
  //       handle: { title: "Shipping Zone", sectionId: "ShippingZoneList" },
  //     },
  //     {
  //       path: "edit/:zoneId",
  //       element: <ShippingZoneForm />,
  //       handle: { title: "Shipping Zone", sectionId: "ShippingZoneUpdateForm" },
  //     },
  //     {
  //       path: "new",
  //       element: <ShippingZoneForm />,
  //       handle: { title: "Shipping Zone", sectionId: "ShippingZoneNewForm" },
  //     },
  //   ],
  // },
