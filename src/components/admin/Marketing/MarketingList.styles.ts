// src/components/Admin/Marketing/MarketingList.styles.ts
...
export const MarketingListContainer = styled.div`
    display: flex;
...
export const MarketingListHeader = styled.div`
    display: flex;
...
export const MarketingSearchInput = styled.input`
...
export const AdminTable = styled.table`
    ...
    tbody td {
        ...
        img { /* Styles for banner image preview in table */
            width: 80px; /* Larger image preview for banners */
...
export const BannerStatusBadge = styled.span<{ $status: 'active' | 'inactive' | 'scheduled' | 'expired' | 'draft' }>`
    padding: 4px 8px;
    border-radius: 6px;
    ...
    ${(props) => props.$status === 'draft' && css`
        background-color: ${rgba(props.theme.colors.adminBorder, 0.5)};
        color: ${props.theme.colors.adminTextSecondary};
    `}
`;
